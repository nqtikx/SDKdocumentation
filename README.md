...
* User registration request: [register](https://app.gitbook.com/o/j3KCkR9ZFffyASIMD6ds/s/wfT58VoRMsqldthmdAbe/)
* User token request: [generate](https://app.gitbook.com/s/wfT58VoRMsqldthmdAbe/#id-5-sdk-token-generation)
...
2. Partner receives `clientId` (`{ id, status }`).
3. (Optional) [Partner checks current status](https://app.gitbook.com/s/wfT58VoRMsqldthmdAbe/#step-2.-check-registered-client-status):\
